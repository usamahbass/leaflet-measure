!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Misura distanze e aree">Misura</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Misura distanze e aree</h3> <ul class=tasks> <a href=# class="js-start start">Crea una nuova misurazione</a> </ul> </div> <div class=js-measuringprompt> <h3>Misura distanze e aree</h3> <p class=js-starthelp>Comincia a creare una misurazione aggiungendo punti alla mappa</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Annulla</a></li> <li><a href=# class="js-finish finish">Misurazione conclusa</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=group> <p class="lastpoint heading">Ultimo punto</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Distanza percorso</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Area</span> {{ model.areaDisplay }}</p> </div> <% } %> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Posizione punto</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centra su questa posizione</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Cancella</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Misura lineare</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centra su questa linea</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Cancella</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
