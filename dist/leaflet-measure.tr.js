!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Uzaklık ve alan hesapla">Hesapla</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Uzaklık ve alan hesapla</h3> <ul class=tasks> <a href=# class="js-start start">Yeni hesaplama</a> </ul> </div> <div class=js-measuringprompt> <h3>Uzaklık ve alan hesapla</h3> <p class=js-starthelp>Yeni nokta ekleyerek hesaplamaya başla</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Çıkış</a></li> <li><a href=# class="js-finish finish">Hesaplamayı bitir</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=group> <p class="lastpoint heading">Son nokta</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Yol uzunluğu</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Alan</span> {{ model.areaDisplay }}</p> </div> <% } %> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Nokta yeri</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Bu yere odaklan</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Sil</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Doğrusal hesaplama</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Bu doğtuya odaklan</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Sil</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
