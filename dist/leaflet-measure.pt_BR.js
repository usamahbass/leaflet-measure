!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<h3>Medida de área</h3> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Perímetro</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centralizar nesta área</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Excluir</a></li> </ul> ';
  }
]);
