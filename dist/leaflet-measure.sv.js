!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Mäta avstånd och yta">Mäta</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Mäta avstånd och yta</h3> <ul class=tasks> <a href=# class="js-start start">Skapa ny mätning</a> </ul> </div> <div class=js-measuringprompt> <h3>Mäta avstånd och yta</h3> <p class=js-starthelp>Börja mätning genom att lägga till punkter på kartan</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Avbryt</a></li> <li><a href=# class="js-finish finish">Avsluta mätning</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=group> <p class="lastpoint heading">Sista punkt</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Total linjelängd</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Yta</span> {{ model.areaDisplay }}</p> </div> <% } %> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Punktens Läge</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centrera på denna punkt</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Radera</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Längdmätning</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centrera på denna linje</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Radera</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Arealmätning</h3> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Omkrets</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centrera på detta område</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Radera</a></li> </ul> ';
  }
]);
