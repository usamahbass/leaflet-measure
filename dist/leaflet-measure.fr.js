!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Mesurer les distances et superficies">Mesure</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Mesurer les distances et superficies</h3> <ul class=tasks> <a href=# class="js-start start">Créer une nouvelle mesure</a> </ul> </div> <div class=js-measuringprompt> <h3>Mesurer les distances et superficies</h3> <p class=js-starthelp>Débuter la création d"une nouvelle mesure en ajoutant des points sur la carte</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Annuler</a></li> <li><a href=# class="js-finish finish">Finir la mesure</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=group> <p class="lastpoint heading">Dernier point</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Distance du chemin</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Superficie</span> {{ model.areaDisplay }}</p> </div> <% } %> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Placement du point</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centrer à cet endroit</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Supprimer</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Mesure linéaire</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centrer sur cette ligne</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Supprimer</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Mesure de superficie</h3> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Périmètre</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centrer sur cette zone</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Supprimer</a></li> </ul> ';
  }
]);
