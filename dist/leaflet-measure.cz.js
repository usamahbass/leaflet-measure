!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="měření vzdáleností a výměr">Měření</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>měření vzdáleností a výměr</h3> <ul class=tasks> <a href=# class="js-start start">provést nové měření</a> </ul> </div> <div class=js-measuringprompt> <h3>měření vzdáleností a výměr</h3> <p class=js-starthelp>proveďte měření přidáním bodů do mapy</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">zrušit</a></li> <li><a href=# class="js-finish finish">ukončit měření</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=group> <p class="lastpoint heading">poslední bod</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>vzdálenost podél úseku</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>výměra</span> {{ model.areaDisplay }}</p> </div> <% } %> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>poloha bodu</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">zacentrovat na tuto obec</a></li> <li><a href=# class="js-deletemarkup deletemarkup">smazat</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>naměřená vzdálenost</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">zacentrovat na tento úsek</a></li> <li><a href=# class="js-deletemarkup deletemarkup">smazat</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
