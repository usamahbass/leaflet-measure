!(function(e) {
  ...
  function(e, t, r) {
    'use strict';
    function o(e, t, r) {
      if (((r = r || {}), !m(r))) throw new Error('options is invalid');
      var o = r.bbox,
        n = r.id;
  ...
  function(e, t, r) {
            ...
            if (null !== (i = d ? c.geometries[g] : c)) {
              ...
              switch (((p = !r || ('Polygon' !== M && 'MultiPolygon' !== M) ? 0 : 1), M)) {
                case null:
                  break;
                case 'Point':
                  if (!1 === t(u, m, y, _, j)) return !1;
                  m++, _++;
                  break;
                case 'LineString':
                case 'MultiPoint':
                  for (n = 0; n < u.length; n++) {
                    if (!1 === t(u[n], m, y, _, j)) return !1;
                    m++, 'MultiPoint' === M && _++;
                  }
                  'LineString' === M && _++;
                  break;
                ...
                case 'MultiLineString':
                  for (n = 0; n < u.length; n++) {
                    for (a = 0; a < u[n].length - p; a++) {
                      if (!1 === t(u[n][a], m, y, _, j)) return !1;
                      m++;
                    }
                ...
                case 'MultiPolygon':
                  for (n = 0; n < u.length; n++) {
                    for ('MultiPolygon' === M && (j = 0), a = 0; a < u[n].length; a++) {
                      for (s = 0; s < u[n][a].length - p; s++) {
                        if (!1 === t(u[n][a][s], m, y, _, j)) return !1;
                        m++;
                      }
                      j++;
                    }
    ...
    function n(e, t) {
      var r,
        ...
        d,
        p = 0,
        m = 'FeatureCollection' === e.type,
        f = 'Feature' === e.type,
        h = m ? e.features.length : 1;
      for (r = 0; r < h; r++) {
        for (
          i = m ? e.features[r].geometry : f ? e.geometry : e,
            u = m ? e.features[r].properties : f ? e.properties : {},
            c = m ? e.features[r].bbox : f ? e.bbox : void 0,
            d = m ? e.features[r].id : f ? e.id : void 0,
          ...
          if (null !== (a = l ? i.geometries[n] : i))
            switch (a.type) {
              ...
              case 'MultiLineString':
              case 'MultiPolygon':
                if (!1 === t(a, p, u, c, d)) return !1;
                break;
              case 'GeometryCollection':
                for (o = 0; o < a.geometries.length; o++)
                  if (!1 === t(a.geometries[o], p, u, c, d)) return !1;
                break;
              default:
                throw new Error('Unknown Geometry Type');
            }
          else if (!1 === t(null, p, u, c, d)) return !1;
        p++;
      }
    }
    function a(e, t, r) {
            ...
            return (
              !1 !==
                o(e, function(o, s, l, c, d) {
                  ...
                  var p = Object(u.e)([i, o], e.properties);
                  if (!1 === t(p, r, n, d, a)) return !1;
                  a++, (i = o);
                }) && void 0
            );
          }
    ...
    (L.Control.Measure = L.Control.extend({
      ...
      initialize: function(e) {
        ...
        var t = this.options,
          r = t.activeColor,
          o = t.completedColor;
        (this._symbols = new m.default({ activeColor: r, completedColor: o })),
  ...
  function(e, t, r) {
    function o(e, t, r) {
      var o = m.imports._.templateSettings || m;
  ...
  function(e, t, r) {
    ...
    function o(e, t, r) {
      ...
      var o = r.units,
        ...
        c = Object(a.a)(s[1]),
        d = Object(a.a)(i[1]),
        p = Math.pow(Math.sin(l / 2), 2) + Math.pow(Math.sin(u / 2), 2) * Math.cos(c) * Math.cos(d);
      return Object(a.g)(2 * Math.atan2(Math.sqrt(p), Math.sqrt(1 - p)), o);
    }
    var n = r(83),
      a = r(3);
    t.a = o;
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Măsurarea distanțelor și a suprafețelor">Măsurare</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Măsurarea distanțelor și a suprafețelor</h3> <ul class=tasks> <a href=# class="js-start start">Efectuează o măsurare nouă</a> </ul> </div> <div class=js-measuringprompt> <h3>Măsurarea distanțelor și a suprafețelor</h3> <p class=js-starthelp>Efectuează o măsurare nouă alegând noi puncte pe hartă</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Oprește</a></li> <li><a href=# class="js-finish finish">Opreste măsurarea</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=group> <p class="lastpoint heading">Ultimul punct</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Distanța dealungul potecii</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Suprafața</span> {{ model.areaDisplay }}</p> </div> <% } %> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Locul punctului</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centrează pe acest loc.</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Șterge</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Distanța măsurată</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centrează pe această linie</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Șterge</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Suprafața măsurată</h3> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Marginea</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centrează pe această poziție</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Șterge</a></li> </ul> ';
  }
]);
