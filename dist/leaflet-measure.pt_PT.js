!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Medir distâncias e áreas">Medições</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Medir distâncias e áreas</h3> <ul class=tasks> <a href=# class="js-start start">Criar uma nova medição</a> </ul> </div> <div class=js-measuringprompt> <h3>Medir distâncias e áreas</h3> <p class=js-starthelp>Adicione pontos no mapa, para criar uma nova medição</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Cancelar</a></li> <li><a href=# class="js-finish finish">Finalizar medição</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
  ...
  function(e, t, r) {
    e.exports =
      '<h3>Localização do ponto</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centrar nesta localização</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Eliminar</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Medição linear</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centrar nesta linha</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Eliminar</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Medição da área</h3> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Perímetro</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centrar nesta área</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Eliminar</a></li> </ul> ';
  }
]);
