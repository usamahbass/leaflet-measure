!(function(e) {
      ...
      for (var v in e)
        (!t && !d.call(e, v)) ||
          (p &&
            ('length' == v ||
              (c && ('offset' == v || 'parent' == v)) ||
              (m && ('buffer' == v || 'byteLength' == v || 'byteOffset' == v)) ||
              l(v, h))) ||
          f.push(v);
      return f;
    }
    ...
    function o(e, t, r) {
      if (null !== e)
        for (
          ...
          (c = h ? e.features[y].geometry : v ? e.geometry : e),
  ...
  function(e, t, r) {
    ...
    var n = r(31),
      ...
      f = r(87),
      h = r(88),
      v = { imports: { numberFormat: f.numberFormat }, interpolate: /{{([\s\S]+?)}}/g },
      b = (0, a.default)(h.controlTemplate, v),
      y = (0, a.default)(h.resultsTemplate, v),
      g = (0, a.default)(h.pointPopupTemplate, v),
      _ = (0, a.default)(h.linePopupTemplate, v),
      j = (0, a.default)(h.areaPopupTemplate, v);
  ...
  function(e, t, r) {
    function o(e, t, r) {
      ...
      var B = t.variable;
      B || (P = 'with (obj) {\n' + P + '\n}\n'),
        (P = (M ? P.replace(h, '') : P).replace(v, '$1').replace(b, '$1;')),
        (P =
          'function(' +
          (B || 'obj') +
          ') {\n' +
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Meritve razdalj in površin">Meritve</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Meritve razdalj in površin</h3> <ul class=tasks> <a href=# class="js-start start">Napravi novo meritev</a> </ul> </div> <div class=js-measuringprompt> <h3>Meritve razdalj in površin</h3> <p class=js-starthelp>Izvedi meritev z vstavljanjem točk v zemljevid</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Prekliči</a></li> <li><a href=# class="js-finish finish">Končaj meritev</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=group> <p class="lastpoint heading">Zadnja točka</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Razdalja vzdolž poti </span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Površina</span> {{ model.areaDisplay }}</p> </div> <% } %> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Položaj točke</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centriraj na ta kraj</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Briši</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Izmerjena razdalja </h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centriraj na to vrstico</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Briši</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Izmerjena površina</h3> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Rob</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centriraj na to površino</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Briši</a></li> </ul> ';
  }
]);
