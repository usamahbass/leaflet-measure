!(function(e) {
  ...
  function(e, t, r) {
    function n(e, t, r) {
      ...
      var S = t.variable;
      S || (P = 'with (obj) {\n' + P + '\n}\n'),
        (P = (x ? P.replace(m, '') : P).replace(y, '$1').replace(v, '$1;')),
        (P =
          'function(' +
          (S || 'obj') +
          ') {\n' +
          ...
          'return __p\n}');
      var A = i(function() {
        return Function(w, C + 'return ' + P).apply(void 0, L);
      });
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Távolság- és területmérések">Mérés</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Távolság- és területmérések</h3> <ul class=tasks> <a href=# class="js-start start">Egy új mérés elvégzése</a> </ul> </div> <div class=js-measuringprompt> <h3>Távolság- és területmérések</h3> <p class=js-starthelp>Végezzen mérést pontok elhelyezésével a térképen.</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Mégse</a></li> <li><a href=# class="js-finish finish">Mérés befejezése</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=group> <p class="lastpoint heading">Utolsó pont</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Kijelölt vonal távolsága</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Terület</span> {{ model.areaDisplay }}</p> </div> <% } %> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Pont helyzete</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">A település közepére igazítani</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Törlés</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Mért távolság</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Közelítés erre a vonalra</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Törlés</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Mért terület</h3> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Szegély</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Közelítés erre a területre</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Törlés</a></li> </ul> ';
  }
]);
