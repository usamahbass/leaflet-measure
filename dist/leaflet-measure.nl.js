!(function(e) {
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Meet afstanden en oppervlakten">Meet</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Meet afstanden en oppervlakten</h3> <ul class=tasks> <a href=# class="js-start start">Maak een nieuwe meting</a> </ul> </div> <div class=js-measuringprompt> <h3>Meet afstanden en oppervlakten</h3> <p class=js-starthelp>Begin een meting door punten toe te voegen aan de kaart</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Annuleer</a></li> <li><a href=# class="js-finish finish">Beëindig meting</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=group> <p class="lastpoint heading">Laatste punt</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Afstand over de lijn</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Oppervlakte</span> {{ model.areaDisplay }}</p> </div> <% } %> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Locatie punt</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centreer op deze locatie</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Wis</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Gemeten afstand</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Centreer op deze lijn</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Wis</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
