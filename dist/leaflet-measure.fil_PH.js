!(function(e) {
                  ...
                  for (o = 0; o < l.length; o++) {
                    for ('MultiPolygon' === x && (j = 0), i = 0; i < l[o].length; i++) {
                      for (a = 0; a < l[o][i].length - p; a++) {
                        if (!1 === t(l[o][i][a], h, v, _, j)) return !1;
                        h++;
                      }
                      j++;
                    }
      ...
      a(e, function(e, r, o) {
        ...
        if (e.geometry) {
          ...
          if ('Point' !== a && 'MultiPoint' !== a) {
            ...
            return (
              !1 !==
                n(e, function(n, a, u, c, f) {
                  if (void 0 === s) return void (s = n);
                  var p = Object(l.e)([s, n], e.properties);
  ...
  function(e, t, r) {
    function n(e, t, r) {
      ...
      r && c(e, t, r) && (t = void 0), (e = d(e)), (t = o({}, t, n, s));
      var j,
        x,
        M = o({}, t.imports, n.imports, s),
        w = f(M),
        k = a(M, w),
        L = 0,
        O = t.interpolate || b,
      ...
      e.replace(E, function(t, r, n, o, i, a) {
        return (
          n || (n = o),
          (P += e.slice(L, a).replace(_, u)),
          r && ((j = !0), (P += "' +\n__e(" + r + ") +\n'")),
          i && ((x = !0), (P += "';\n" + i + ";\n__p += '")),
          n && (P += "' +\n((__t = (" + n + ")) == null ? '' : __t) +\n'"),
          (L = a + t.length),
  ...
  function(e, t, r) {
    function n(e, t, r, n) {
      ...
      for (var s = -1, u = t.length; ++s < u; ) {
        ...
        void 0 === c && (c = e[l]), a ? i(r, l, c) : o(r, l, c);
      }
      return r;
    }
    var o = r(34),
  ...
  function(e, t, r) {
    function n(e) {
      return !(!a(e) || i(e)) && (o(e) ? d : l).test(s(e));
    }
    var o = r(10),
      i = r(40),
      a = r(2),
