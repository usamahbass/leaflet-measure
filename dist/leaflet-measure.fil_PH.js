!(function(e) {
      ...
      if (null !== e)
        for (
          var n,
            ...
            b = 'Feature' === f,
            y = h ? e.features.length : 1,
            v = 0;
          v < y;
          v++
        ) {
          (c = h ? e.features[v].geometry : b ? e.geometry : e),
            ...
            if (null !== (i = d ? c.geometries[g] : c)) {
              ...
              switch (((p = !r || ('Polygon' !== M && 'MultiPolygon' !== M) ? 0 : 1), M)) {
                case null:
                  break;
                case 'Point':
                  if (!1 === t(u, m, v, _, j)) return !1;
                  m++, _++;
                  break;
                case 'LineString':
                case 'MultiPoint':
                  for (n = 0; n < u.length; n++) {
                    if (!1 === t(u[n], m, v, _, j)) return !1;
                    m++, 'MultiPoint' === M && _++;
                  }
                  'LineString' === M && _++;
                  break;
                  ...
                  for (n = 0; n < u.length; n++) {
                    for ('MultiPolygon' === M && (j = 0), a = 0; a < u[n].length; a++) {
                      for (s = 0; s < u[n][a].length - p; s++) {
                        if (!1 === t(u[n][a][s], m, v, _, j)) return !1;
                        m++;
                      }
                      j++;
                    }
  ...
  function(e, t, r) {
    ...
    var n = r(31),
      ...
      y = (0, a.default)(h.controlTemplate, b),
      v = (0, a.default)(h.resultsTemplate, b),
  ...
  function(e, t, r) {
    function o(e, t, r) {
      ...
      var B = t.variable;
      B || (P = 'with (obj) {\n' + P + '\n}\n'),
        (P = (M ? P.replace(h, '') : P).replace(b, '$1').replace(y, '$1;')),
        (P =
          'function(' +
          (B || 'obj') +
          ') {\n' +
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Kalkulahin ang tamang distansya at sukat">Sukat</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Kalkulahin ang tamang distansya at sukat</h3> <ul class=tasks> <a href=# class="js-start start">Lumikha ng isang bagong pagsukat</a> </ul> </div> <div class=js-measuringprompt> <h3>Kalkulahin ang tamang distansya at sukat</h3> <p class=js-starthelp>Simulan ang paglikha ng isang pagsukat sa pamamagitan ng pagdaragdag ng mga puntos sa mapa</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Kanselahin</a></li> <li><a href=# class="js-finish finish">Tapusin ang pagsukat</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=group> <p class="lastpoint heading">Huling punto sa mapa</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Distansya ng daanan</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Sukat</span> {{ model.areaDisplay }}</p> </div> <% } %> ';
  },
  function(e, t, r) {
    e.exports =
  ...
  function(e, t, r) {
    e.exports =
      '<h3>Pagsukat ng guhit</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">I-sentro sa linya na ito</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Tanggalin</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
