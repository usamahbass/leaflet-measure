!(function(e) {
    ...
    function o(e, t, r) {
      ...
      B || (P = 'with (obj) {\n' + P + '\n}\n'),
        ...
        (P =
          ...
          'return __p\n}');
      var S = a(function() {
        return Function(k, E + 'return ' + P).apply(void 0, x);
      });
  ...
  function(e, t, r) {
    e.exports =
      '<a class="{{ model.className }}-toggle js-toggle" href=# title="Mengukur jarak dan daerah">Mengukur</a> <div class="{{ model.className }}-interaction js-interaction"> <div class="js-startprompt startprompt"> <h3>Mengukur jarak dan daerah</h3> <ul class=tasks> <a href=# class="js-start start">Buat pengukuran baru</a> </ul> </div> <div class=js-measuringprompt> <h3>Mengukur jarak dan daerah</h3> <p class=js-starthelp>Mulailah membuat pengukuran dengan menambahkan titik ke peta</p> <div class="js-results results"></div> <ul class="js-measuretasks tasks"> <li><a href=# class="js-cancel cancel">Batal</a></li> <li><a href=# class="js-finish finish">Selesaikan pengukuran</a></li> </ul> </div> </div> ';
  },
  function(e, t, r) {
    e.exports =
      '<div class=group> <p class="lastpoint heading">Poin terakhir</p> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> </div> <% if (model.pointCount > 1) { %> <div class=group> <p><span class=heading>Jarak jalur</span> {{ model.lengthDisplay }}</p> </div> <% } %> <% if (model.pointCount > 2) { %> <div class=group> <p><span class=heading>Daerah</span> {{ model.areaDisplay }}</p> </div> <% } %> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Lokasi titik</h3> <p>{{ model.lastCoord.dms.y }} <span class=coorddivider>/</span> {{ model.lastCoord.dms.x }}</p> <p>{{ numberFormat(model.lastCoord.dd.y, 6) }} <span class=coorddivider>/</span> {{ numberFormat(model.lastCoord.dd.x, 6) }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Pusatkan di lokasi ini</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Hapus</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Pengukuran linier</h3> <p>{{ model.lengthDisplay }}</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Pusatkan di baris ini</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Hapus</a></li> </ul> ';
  },
  function(e, t, r) {
    e.exports =
      '<h3>Pengukuran luas</h3> <p>{{ model.areaDisplay }}</p> <p>{{ model.lengthDisplay }} Keliling</p> <ul class=tasks> <li><a href=# class="js-zoomto zoomto">Pusatkan di area ini</a></li> <li><a href=# class="js-deletemarkup deletemarkup">Hapus</a></li> </ul> ';
  }
]);
