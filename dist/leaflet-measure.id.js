!(function(e) {
            ...
            if (null !== (a = f ? c.geometries[b] : c)) {
              ...
              switch (((p = !r || ('Polygon' !== x && 'MultiPolygon' !== x) ? 0 : 1), x)) {
                case null:
                  break;
                case 'Point':
                  if (!1 === t(l, h, v, _, j)) return !1;
                  h++, _++;
                  break;
                case 'LineString':
                case 'MultiPoint':
                  for (o = 0; o < l.length; o++) {
                    if (!1 === t(l[o], h, v, _, j)) return !1;
                    h++, 'MultiPoint' === x && _++;
                  }
                  'LineString' === x && _++;
                  break;
                  ...
                  for (o = 0; o < l.length; o++) {
                    for ('MultiPolygon' === x && (j = 0), i = 0; i < l[o].length; i++) {
                      for (s = 0; s < l[o][i].length - p; s++) {
                        if (!1 === t(l[o][i][s], h, v, _, j)) return !1;
                        h++;
                      }
                      j++;
                    }
  ...
  function(e, t, r) {
    ...
    (L.Control.Measure = L.Control.extend({
      ...
      _initLayout: function() {
        ...
        (t.innerHTML = g({ model: { className: e } })),
  ...
  function(e, t, r) {
    function n(e, t, r) {
      ...
      var S = t.variable;
      S || (P = 'with (obj) {\n' + P + '\n}\n'),
        (P = (x ? P.replace(m, '') : P).replace(y, '$1').replace(g, '$1;')),
        (P =
          'function(' +
          (S || 'obj') +
          ') {\n' +
          ...
          'return __p\n}');
      var A = i(function() {
        return Function(w, C + 'return ' + P).apply(void 0, k);
      });
